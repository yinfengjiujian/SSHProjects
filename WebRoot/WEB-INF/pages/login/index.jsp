...
<title>核心业务基础框架</title>
<%@ include file="/comment/pages/basessh.jsp"%>
</head>
<body>
	<div id="layout">
		<%--图标开头导航区域***********Start--%>
		<div id="header">
			<div class="headerNav">
				...
				<ul class="nav">
					<li id="switchEnvBox"><a href="javascript:">（<span>北京</span>）切换城市</a>
						<ul>
							<li><a href="<%=path%>/comment/dwz/sidebar_1.html">北京</a></li>
							<li><a href="<%=path%>/comment/dwz/sidebar_2.html">上海</a></li>
							<li><a href="<%=path%>/comment/dwz/sidebar_2.html">南京</a></li>
							<li><a href="<%=path%>/comment/dwz/sidebar_2.html">深圳</a></li>
							<li><a href="<%=path%>/comment/dwz/sidebar_2.html">广州</a></li>
							<li><a href="<%=path%>/comment/dwz/sidebar_2.html">天津</a></li>
							<li><a href="<%=path%>/comment/dwz/sidebar_2.html">杭州</a></li>
						</ul>
					</li>
					<li><a href="<%=path%>/comment/dwz/donation.html" target="dialog" height="400" title="捐赠 & DWZ学习视频">捐赠</a></li>
					<li><a href="<%=path%>/comment/dwz/changepwd.html" target="dialog" width="600">设置</a></li>
					<li><a href="http://www.cnblogs.com/dwzjs" target="_blank">博客</a></li>
					<li><a href="http://weibo.com/dwzui" target="_blank">微博</a></li>
					<li><a href="<%=path%>/comment/dwz/login.html">退出</a></li>
				</ul>
			...
			<div id="navMenu">
				<ul>
					<c:forEach var="sysMenus" items="${ListMenus}">
						<c:choose>
							<c:when test="${sysMenus.menuId == fristmunus.menuId}"><li class="selected"><a href="222"><span>${sysMenus.menuName}</span></a></li></c:when>
							<c:otherwise><li><a href="#"><span>${sysMenus.menuName}</span></a></li></c:otherwise>
						</c:choose>
					</c:forEach>
				</ul>
			</div>
		...
		<div id="leftside">
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					<duanml:Menutree treeContent="accordionContent" treeStyle="tree treeFolder" 
					treeHead="accordionHeader"	treeTarget="navTab"></duanml:Menutree>
<%--						document.getElementsById("CurInfo").searchType="修改后的值" --%>
				</div>
			</div>
		</div>
		<%--左边菜单导航栏目*********End	--%>
